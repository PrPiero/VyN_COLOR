            ...
            <ul>
                @foreach ($category->subcategories as $subcategory)
                    <li class="my-2 text-sm  ">
                        <a class="cursor-pointer hover:text-yellow-600  border-gray-600 capitalize block px-4 py-1 rounded-lg shadow {{$subcategoria == $subcategory->slug ? 'text-yellow-600 font-semibold' : ''}}"
                    ...
                    @empty
                        <li class="md:col-span-2 lg:col-span-4">
                            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                                ...
                                <span class="block sm:inline">No hay existencias.</span>
                            </div>
                        </li>
                    @endforelse
                </ul>
