<div>
    ...
    <x-jet-action-section>
        ...
        <x-slot name="description">
            En este apartado se encuentran todas las categorías registradas
        </x-slot>
        <x-slot name="content">
                        ...
                        <tr>
                            ...
                            <td class="py-2">
                                <div class="flex divide-x divide-gray-300 font-semibold">
                                    ...
                                    <a class="pr-2 hover:text-red-600 cursor-pointer" wire:click="$emit('deleteCategory', '{{ $category->slug }}')">Eliminar</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
        ...
        <x-slot name="content">
            <div class="space-y-3">
                <div>
                    ...
                    @else
                        <img class="w-full h-64 object-cover object-center" src="{{ '/storage/' . $editForm['image'] }}" alt="">
                    @endif
                </div>
                <div>
                    <x-jet-label>
