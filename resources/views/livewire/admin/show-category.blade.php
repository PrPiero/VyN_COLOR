<div class="container py-12">
    ...
    <x-jet-action-section>
        ...
        <x-slot name="description">
            En este apartado se encuentran todas las subcategorías registradas
        </x-slot>
        <x-slot name="content">
                        ...
                        <tr>
                            ...
                            <td class="py-2">
                                <div class="flex divide-x divide-gray-300 font-semibold">
                                    ...
                                    <a class="pr-2 hover:text-red-600 cursor-pointer" wire:click="$emit('deleteSubcategory', '{{ $subcategory->id }}')">Eliminar</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
