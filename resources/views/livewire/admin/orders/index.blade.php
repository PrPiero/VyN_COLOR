<x-admin-layout>
    <div class="container py-12">
        <section class="grid grid-cols-5 gap-6 text-white">
            ...
            <a href="{{route('admin.orders.index') . "?status=1"}}" class="bg-yellow-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
            ...
            <a href="{{route('admin.orders.index') . "?status=3"}}" class="bg-blue-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{$enviado}}
                </p>
                        ...
                        <li>
                            <a href="{{route('admin.orders.show', $order)}}" class="flex items-center py-2 px-4 hover:bg-gray-100">
                                <span class="w-12 text-center">
                                    @switch($order->status)
                                        @case(1)
                                            <i class="fas fa-business-time text-yellow-500 bg-opacity-50"></i>
                                            @break
                                        @case(2)
                                            <i class="fas fa-credit-card text-gray-500 bg-opacity-50"></i>
                                            @break
                                        @case(3)
                                            <i class="fas fa-truck text-blue-500 bg-opacity-50"></i>
                                            @break
                                        @case(4)
                                            <i class="fas fa-check-circle text-green-500 bg-opacity-50"></i>
                                            @break
                                        @case(5)
                                            <i class="fas fa-times-circle text-red-500 bg-opacity-50"></i>
                                            @break
                                        @default
