                    ...
                    @foreach ($product_colors as $product_color)
                        <tr wire:key="product_color-{{$product_color->pivot->id}}">
                            ...
                            <td class="px-4 py-2 flex">
                                <x-jet-button class="bg-green-500 hover:bg-green-700 ml-auto mr-2" wire:click="edit( {{$product_color->pivot->id}})" wire:loading.attr="disabled" wire:target="edit( {{$product_color->pivot->id}})">
                                    ACTUALIZAR
                                </x-jet-button>
